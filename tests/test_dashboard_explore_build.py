...
def _seed_explore_fixture(
    ...
    *,
    ...
    games/<pk>.json + explore-metadata.json, all internally consistent by
    default. Returns (players_path, players_dir, games_dir, metadata_path).
    """
    ...
    return players_path, players_dir, games_dir, metadata_path
...
class TestExploreLandingPage:
    def test_explore_page_renders_when_fixture_present(self, tmp_path: Path) -> None:
        ...
        players_path, players_dir, games_dir, metadata_path = _seed_explore_fixture(tmp_path)
        _build(tmp_path, out_root, art_root, players_path, players_dir, games_dir, metadata_path)
    ...
    def test_players_catalog_one_entry_per_represented_batter(self, tmp_path: Path) -> None:
        ...
        players_path, players_dir, games_dir, metadata_path = _seed_explore_fixture(
...
class TestExploreMetadataBuildGuard:
    ...
    def test_build_rejects_wrong_play_ledger_version(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(ec.ExploreContentError, match="play_ledger_version"):
            _build(
                tmp_path, out_root, art_root, players_path, players_dir, games_dir, metadata_path
            )
