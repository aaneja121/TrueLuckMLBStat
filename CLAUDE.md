...
This file governs how Claude Code (and any other AI coding agent) should work in
**Contact Luck Prototype v0.1**. Read `README.md` first for project scope and
terminology; this file is about *how to work here safely*, not *what the project is*.
